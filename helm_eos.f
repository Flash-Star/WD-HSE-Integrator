...
c..for the tables, in general
      integer          imax,jmax
        !don: updated imax and jmax for use with Timmes' helmholtz table on the web Dec. 8, 2014
...
c..read the helmholtz free energy table
       !don: updated tlo, thi, dlo, dhi for use with Timmes' helmholtz table on the web Dec. 8, 2014
       tlo   = 3.0d0
       thi   = 13.0d0
